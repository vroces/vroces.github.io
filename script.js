document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('download-btn').addEventListener('click', function() {
    ...
    link.href = '/public/resume.pdf';  // Path to your resume in the public folder
    link.download = 'Resume.pdf';  // Name of the file when it's downloaded
    link.click();
  });
  ...
  function sendMail() {
    ...
    const mailtoLink = `mailto:vicroces83@gmail.com?subject=Message from ${name}&body=Name: ${name}%0D%0AEmail: ${email}%0D%0AMessage: ${message}`;
